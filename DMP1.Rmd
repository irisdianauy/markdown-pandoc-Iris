...
# Background {-}
![Figure 1. Area Map](/afs/ictp.it/home/i/iuy/markdown-pandoc-Iris/img/rio-grande-basin.png){ width=50% }
...
the entire geodatabase[^i].

[^i]:The FGDC standard was chosen due to required Federal government standards.
...
1. The database will be preserved in perpetuity, housed initially at the 
    a. New Mexico Interstate Stream
    a. Commission Central Office in addition to an off-site copy maintained at
an 
    a. NMISC field office and mirrored at the Consortium of Universities for
the 
    a. Advancement of Hydrologic Science (CUAHSI). 
...
software programs. 
The data manager at the NMISC will be responsible for
